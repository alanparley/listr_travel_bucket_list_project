...
country_1 = Country("Germany", False)
country_repository.save(country_1)
country_2 = Country("France", True)
country_repository.save(country_2)
country_3 = Country("Italy", False)
country_repository.save(country_3)


city_1 = City("Berlin", country_1, True)
city_repository.save(city_1)
city_2 = City("Paris", country_2, False)
city_repository.save(city_2)
city_3 = City("Rome", country_3, True)
city_repository.save(city_3)
city_4 = City("Hamburg", country_1, False)
city_repository.save(city_4)
city_5 = City("Milan", country_3, True)
